...
feature "Manage alerts" do
  ...
  scenario "Sign up for email alert" do
    VCR.use_cassette('planningalerts') do
      ...
      fill_in("alert_address", :with => "Station Road, Liss")
    ...
    current_email.default_part_body.to_s.should include("Station Road, Liss")
    click_first_link_in_email

    page.should have_content("your alert has been activated")
    page.should have_content("Station Road, Liss")
    Alert.active.find(:first, :conditions => {:address => "Station Road, Liss, Liss, Hampshire GU33", :radius_meters => "2000", :email => current_email_address}).should_not be_nil
  end
